...
# for key in dic:
#     print(type(key))
#     print(dic[key]) # => dict['Track'], dict['Intake']
...
#         continue
#     #1parse data
#     #2 store dynamo database on server
#     print(i)
#     i-=1
# flag = True
# x = 5
...
# for day in lis_date:
#     if day == '1':
#         day = datetime.now() - datetiem.timetilda(1)
#     if day == '2':
#         day = datetime.now() - datetiem.timetilda(2)
#     if day == '3':
#         day = datetime.now() - datetiem.timetilda(3)
...
def my_func(x, *args, **kwargs):
    print(args)
    print(kwargs)
my_func(1,2,4,5,6, name='Ahmed', Track="ITI")
# def x(x=0,y, k):
#     print(x)
#     print(y)
#     print(k)
